...
print(sopa.p)  # procura a primeira tag com P ou qualquer letra que quiser
print(sopa.p.string) # transformou em string
print(sopa.find('admin')) # traz informações sobre o administrador da página se houver